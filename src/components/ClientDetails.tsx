              ...
              <tbody className="divide-y divide-gray-200">
                {filteredClients.map((client: Client) => (
                  <tr key={client.id} className="hover:bg-gray-50 transition">
                    ...
                    <td className="px-3 py-2 text-gray-700">{client.email}</td>
                    <td className="px-3 py-2 text-gray-700">{client.phone}</td>
                    <td className="px-3 py-2 text-gray-700">{client.domain}</td>
                    <td className="px-3 py-2 text-gray-700">{client.country}</td>
                    <td className="px-3 py-2">
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-semibold ${
